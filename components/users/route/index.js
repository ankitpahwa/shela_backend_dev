...
module.exports = [{
    ...
    {
        method: 'POST',
        path: '/api/users/appleLoginSignUp',
        options: specs.appleLoginSignUp,
        handler: api.appleLoginSignUp
    },
    {
        method: 'GET',
        ...
        method: 'GET',
        path: '/api/users/verifyResetAdminPasswordToken',
        options: specs.verifyResetPasswordToken,
        handler: api.verifyResetAdminPasswordToken
    }, {
        method: 'GET',
        ...
        method: 'POST',
        path: '/api/users/setNewAdminPassword',
        options: specs.setNewPassword,
        handler: api.setNewAdminPassword
    }, {
        method: 'POST',
    ...
    {
        method: 'POST',
        path: '/api/employer/searchEmployeeHome',
        options: specs.searchEmployeeHome,
        handler: api.searchEmployeeHome
    },
    ...
    {
        method: 'GET',
        path: '/api/employer/fetchReviews',
        options: specs.fetchReviews,
        handler: api.fetchReviews
    },
    {
        method: 'POST',
    ...
    {
        method: 'POST',
        path: '/api/users/employersLeads',
        options:specs.EmployersContactLeads,
        handler: api.EmployersContactLeads
    },
    {
        method: 'POST',
        path: '/api/users/employeesLeads',
        options:specs.EmployeesContactLeads,
        handler: api.EmployeesContactLeads
    },
    {
        method: 'POST',
