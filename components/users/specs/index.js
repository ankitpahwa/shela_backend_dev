...
,
    ...
    searchEmployeeHome: {
        description: ' For searching Employee Home  ',
        notes: "For searching Employee Home",
        tags: ['api', 'users'],
        validate: {
            payload: validator.searchEmployee.payload,
            failAction: response.failAction
   ...
   registrationappUs: {
    ...
    fetchReviews: {
        ...
        validate: {
            headers: validator.header,
            //query: validator.fetchReviews.query,
            failAction: response.failAction
        }
    },
    ...
    socialLoginSignUp: {
        ...
        notes: "2 for facebOok, 3 for google,4 for linkedIn, 4 for apple login",
        tags: ['api', 'users'],
        validate: {
    ...
    sociaappleLoginSignUplLoginSignUp: {
        description: 'Apple Social Signup/Login  ',
        notes: "for apple login",
        tags: ['api', 'users'],
        validate: {
     //       payload: validator.appleLoginSignUp.payload,
            failAction: response.failAction
        }
    },
