...
const users = new mongoose.Schema({
    ...
    currentPositionId: { type: String,ref:"currentPosition" },
    ...
    // Profile set complete status
    isProfileCompletedStep1: {type : Boolean, default: false},
    isProfileCompletedStep2: {type : Boolean, default: false},
    isProfileCompletedStep3: {type : Boolean, default: false},
    isProfileCompletedStep4: {type : Boolean, default: false},
