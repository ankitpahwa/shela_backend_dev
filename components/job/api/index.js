...
const jobProfile = async (request, h) => {
    ...
    try {
        ...
        message.push({
            "selfProfile": {
                "profileStepCompleted": request.userInfo.profileStepCompleted,
                "isProfileCompletedStep1": request.userInfo.isProfileCompletedStep1,
                "isProfileCompletedStep2": request.userInfo.isProfileCompletedStep2,
                "isProfileCompletedStep3": request.userInfo.isProfileCompletedStep3,
                "isProfileCompletedStep4": request.userInfo.isProfileCompletedStep4,
            }
        })
        log.end()
        return response.success(h, message)
...
const fetchUserProfile = async (request, h) => {
    ...
    try {
        ...
        console.log("End fetchUserProfile");
	log.end()
        return response.success(h, message)
    } catch (err) {
        log.error(err)
