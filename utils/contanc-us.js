...
const emailTo = "v5.netclues@gmail.com";
const forward = async (emailTo, content, types, saveInDb, context) => {
        ...
        switch (type) {
            ...
            case 'email':
                const body = templateHelper
                    ...
                    .inject(content.data)
                require('../providers/contactus').send(emailTo, subject, body, context)
        }
    }
    log.end()
}
